...
export class BattleCalculator {
  ...
  calculateBattleStats(
    ...
    const codeWarriorScore = this.calculateCodeWarriorScore(
      user,
      repositories,
      analytics
    );
    const communityChampionScore = this.calculateCommunityChampionScore(
      user,
      repositories
    );
    const techExplorerScore = this.calculateTechExplorerScore(
      analytics,
      repositories
    );
    const growthMasterScore = this.calculateGrowthMasterScore(user, analytics);
    const impactPlayerScore = this.calculateImpactPlayerScore(repositories);
  ...
  private calculateCodeWarriorScore(
    user: GitHubUser,
    repositories: Repository[],
    analytics: SkillAnalysis
  ): number {
  ...
  private calculateCommunityChampionScore(
    user: GitHubUser,
    repositories: Repository[]
  ): number {
  ...
  private calculateTechExplorerScore(
    analytics: SkillAnalysis,
    repositories: Repository[]
  ): number {
  ...
  private calculateGrowthMasterScore(
    user: GitHubUser,
    analytics: SkillAnalysis
  ): number {
    ...
    const avgCommitsPerDay = analytics.avgCommitsPerDay || 0;
    const productivity = avgCommitsPerDay * 365; // yearly productivity
  ...
  private calculateImpactPlayerScore(repositories: Repository[]): number {
